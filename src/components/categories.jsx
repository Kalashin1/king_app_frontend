      ...
      <div className="row px-xl-5 pb-3">
        <div className="col-lg-4 col-md-6 pb-1">
          <div className="cat-item d-flex flex-column border mb-4" style={{ padding: '30px' }}>
            ...
            <h5 className="font-weight-semi-bold m-0">Mens dresses</h5>
          </div>
        </div>
        <div className="col-lg-4 col-md-6 pb-1">
          <div className="cat-item d-flex flex-column border mb-4" style={{ padding: '30px' }}>
            ...
            <h5 className="font-weight-semi-bold m-0">Womens dresses</h5>
          </div>
        </div>
        <div className="col-lg-4 col-md-6 pb-1">
          <div className="cat-item d-flex flex-column border mb-4" style={{ padding: '30px' }}>
            ...
            <h5 className="font-weight-semi-bold m-0">Babys dresses</h5>
          </div>
        </div>
        <div className="col-lg-4 col-md-6 pb-1">
          <div className="cat-item d-flex flex-column border mb-4" style={{ padding: '30px' }}>
